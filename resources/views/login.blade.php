                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form action="/actlog" method="get" class="mt-5 mb-5 login-input">
                                ...
                                <p class="mt-5 login-form__footer">Jika belum mempunyai akun? silahkan daftar <a href="/register" class="text-primary">disini</a> sekarang</p>
                            </div>
                        </div>
                    </div>
                </div>
